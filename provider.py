...
def get_city(city_id):
    ...
    4) Look up disaster resource data from local database instead of bc.users.
    5) Return JSON with city disaster management info or 404 if missing.
    """
    ...
    # ─── (3) Look up the city disaster resources from local database ───────────
